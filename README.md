...
* A Copy of Beta 3 With Melonloader installed (for OceanDrive and StormDrain)
* [ShrimpleMapExporter](https://github.com/blankochan/ShrimpleMapExporter/releases/latest)
* [ShrimpleMapLoader](https://github.com/blankochan/ShrimpleMapLoader/releases/tag/latest)
* [ShrimpleNetworkingAPI](https://github.com/blankochan/ShrimpleNetworkingAPI/releases/tag/latest)

1. Install [`ShrimpleMapExporter`](https://github.com/blankochan/ShrimpleMapExporter/releases/latest) into Beta 2 & 3
2. Start Beta 2 & 3 atleast once
